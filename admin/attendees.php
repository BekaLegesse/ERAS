		...
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary"
					href="./index.php?page=new_attendee"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
					...
					while ($row = $qry->fetch_assoc()):
						...
						<tr>
							...
							<td class="text-center">
								<div class="btn-group">
									<a href="./index.php?page=edit_attendee&id=<?php echo $row['id'] ?>"
										class="btn btn-primary btn-flat">
										<i class="fas fa-edit"></i>
									</a>
									<button href="button" class="btn btn-info btn-flat view_attendee"
										data-id="<?php echo $row['id'] ?>">
										<i class="fas fa-eye"></i>
									</button>
									<button type="button" class="btn btn-danger btn-flat delete_attendee"
										data-id="<?php echo $row['id'] ?>">
